...
namespace Plex2Sonos.Sonos.DTO
{
    ...
    [System.ServiceModel.MessageContract(WrapperName = "getMetadataResponse", WrapperNamespace = "http://www.sonos.com/Services/1.1", IsWrapped = true)]
    public partial class getMetadataResponse
    {
        ...
        public mediaList getMetadataResult;

        public getMetadataResponse()
        {
        }

        public getMetadataResponse(mediaList getMetadataResult)
        {
